...
MyTimerObj ::~MyTimerObj() { timeEndPeriod(MAtc.wPeriodMin); }
void MyTimerObj ::SetFPS(int ifps) {
    ...
    if (MisTGT) {
        ...
        MUtimervalue.SforPC.Mcountperframe =
                (INT32)(MUtimervalue.SforPC.Mfreq.QuadPart / ifps);
        MUtimervalue.SforPC.Mgiveuptime =
                MUtimervalue.SforPC.Mcountperframe * GIVEUPFRAME;
        MUtimervalue.SforPC.Mframeskipreqtime =
                (int)(MUtimervalue.SforPC.Mcountperframe * (1 + FSREQFRAME));
    }
}
bool MyTimerObj ::Wait(MSG* iptrmsg) {
    ...
    if (MisTGT) {
        ...
        for (;;) {
            ...
            if (!pressurerecoded) {
                Mpressure =
                        MUtimervalue.SforTGT.Mendtime - MUtimervalue.SforTGT.Mstarttime;
                pressurerecoded = true;
            }
#endif
            timegap = MUtimervalue.SforTGT.Mendtime - MUtimervalue.SforTGT.Mstarttime;
            if (MUtimervalue.SforTGT.Msecondstarttime - MUtimervalue.SforTGT.Mendtime >=
                1000) {
                MFPS = MFPScounter;
                MFPScounter = 0;
            ...
            if (timegap >= F2I(MUtimervalue.SforTGT.Mfixwaittime)) {
                if (timegap < MUtimervalue.SforTGT.Mgiveuptime)
                    MUtimervalue.SforTGT.Mstarttime +=
                            F2I(MUtimervalue.SforTGT.Mfixwaittime);
                else
                    MUtimervalue.SforTGT.Mstarttime = MUtimervalue.SforTGT.Mendtime;
                MUtimervalue.SforTGT.Mfixwaittime =
                        MUtimervalue.SforTGT.Mfixwaittime +
                        MUtimervalue.SforTGT.Mfixhztime -
                        (MUtimervalue.SforTGT.Mfixwaittime & DEGMASK);
                Mframeskiprequired = false;
                if (timegap > MUtimervalue.SforTGT.Mframeskipreqtime)
                    Mframeskiprequired = true;
                MFPScounter++;
                break;
    ...
    } else  //! isTGT
    {
        ...
        for (;;) {
...
#ifdef _DEBUG
            if (!pressurerecoded) {
                Mpressure = (int)(MUtimervalue.SforPC.Mendtime.QuadPart -
                                  MUtimervalue.SforPC.Mstarttime.QuadPart);
                pressurerecoded = true;
            }
#endif
            timegap = (long)(MUtimervalue.SforPC.Mendtime.QuadPart -
                             MUtimervalue.SforPC.Mstarttime.QuadPart);
            if (MUtimervalue.SforPC.Mendtime.QuadPart -
                        MUtimervalue.SforPC.Msecondstarttime.QuadPart >=
                MUtimervalue.SforPC.Mfreq.QuadPart) {
                MUtimervalue.SforPC.Msecondstarttime.QuadPart +=
                        MUtimervalue.SforPC.Mfreq.QuadPart;
                MFPS = MFPScounter;
                MFPScounter = 0;
            ...
            if (timegap >= MUtimervalue.SforPC.Mcountperframe) {
                if (timegap < MUtimervalue.SforPC.Mgiveuptime)
                    MUtimervalue.SforPC.Mstarttime.QuadPart +=
                            MUtimervalue.SforPC.Mcountperframe;
                else
                    MUtimervalue.SforPC.Mstarttime.QuadPart =
                            MUtimervalue.SforPC.Mendtime.QuadPart;
                Mframeskiprequired = false;
                if (timegap > MUtimervalue.SforPC.Mframeskipreqtime)
                    Mframeskiprequired = true;
                MFPScounter++;
                break;
            }
            if (timegap <
                MUtimervalue.SforPC.Mcountperframe -
                        MUtimervalue.SforPC.Mfreq.QuadPart * SLEEPEND / 1000) {
                Sleep(1);
                MNOsleep++;
            } else
                Sleep(0);
...
double MyTimerObj ::ProcessTimeCount() {
    if (MisTGT) {
        ...
        timegap = (long)(tmp.QuadPart - MUtimervalue.SforPC.Mprocessstart.QuadPart);
